...
@property (nonatomic, strong) NSArray * goods_content;
@property (nonatomic, strong) NSString * goods_desc;
@property (nonatomic, strong) NSArray * goods_img;
@property (nonatomic, strong) NSArray * goods_img_f;
...
@property (nonatomic, strong) NSArray * goods_tags_name;
...
@property (nonatomic, strong) NSArray * purchase_notes;
