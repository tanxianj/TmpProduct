...
@property(nonatomic,strong)UIImage * currentScreenShotImg;
...
//#warning Bar
//    UIImage *backButtonImage = [[UIImage imageNamed:@"return"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
...
//    self.view.layer.shadowOffset = CGSizeMake(-0.1, 0);
...
//        self.animationController.screenImg = self.screenshotImgs.lastObject;
//    }else{
//        self.animationController.screenImg = self.currentScreenShotImg;
//    }
...
//        }else{
//            self.currentScreenShotImg = snapshot;
//        }
//    }
//    
//    
