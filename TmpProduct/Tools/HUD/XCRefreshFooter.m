...
{
    XCRefreshFooter *cmp = [[self alloc] init];
    cmp.hasTopSpace = YES;
...
//    self.backgroundColor = [UIColor whiteColor];
    ...
    [self setTitle:kNetworkErrorPromptText forState:MJRefreshStateError];
